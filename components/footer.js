    ...
    <div className="relative">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
              CUET CONNECT💐 is a platform for connecting students, alumni and teachers with each other.
            </div>
          ...
          <div>
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              {navigation.map((item, index) => (
                <Link key={index} href="https://abusayed.dev/">
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
          Copyright © {new Date().getFullYear()}. Made with ♥ by SAYED
        </div>
      </Container>
      {/* Do not remove this */}
      <Backlink />
...
const Backlink = () => {
  return (
    <a
      href="https://vercel.com?utm_source=next.js"
      className="absolute flex px-3 py-1 space-x-2 text-sm font-semibold text-gray-900 bg-white border border-gray-300 rounded shadow-sm place-items-center left-5 bottom-5 dark:bg-trueGray-900 dark:border-trueGray-700 dark:text-trueGray-300"
    >
      <span>
        <PoweredByVercel utmSource="https://cuetconnect.org/" />
      </span>
    </a>
  );
};
