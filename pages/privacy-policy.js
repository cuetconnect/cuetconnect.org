  ...
  return (
    <>
      ...
      <section class="bg-white dark:bg-trueGray-900">
        <div class=" container px-0 py-2 grid mx-auto grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-1 xl:grid-cols-1">
          ...
          <ul className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
            <li>
              <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
                <strong className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
                  Account
                </strong>{" "}
            ...
            <li>
              <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
                ...
                refers to CUET CONNECT, accessible from{" "}
                <a
                  href="https://cuetconnect.org/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://cuetconnect.org/
                </a>
              </p>
            </li>
            <li>
          ...
          <h3 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
            Personal Data
          </h3>
          <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
          ...
          <ul className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
            ...
            <li>
              <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
                ...
                <a
                  href="https://cuetconnect.org/contact"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://cuetconnect.org/contact
                </a>
              </p>
            </li>
          </ul>
